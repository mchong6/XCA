...
opt = lapp[[
   -s,--save                  (default "logs_hot_split_3_class")      subdirectory to save logs
   ...
   --model                    (default vgg_bn_drop_split3class)     model name
...
nRepeat = 1
labelLength = 7
--label: xA,AB(A),xB,AB(B),AB(AB)
--label 3 class: xA,AB(A),xB,AB(B),xC, AB(C), AB(AB)
label0 = torch.cat({torch.ones(nRepeat), torch.zeros(nRepeat), torch.zeros(nRepeat), torch.zeros(nRepeat), torch.zeros(nRepeat), torch.zeros(nRepeat), torch.ones(nRepeat)}, 1)
label1 = torch.cat({torch.zeros(nRepeat), torch.zeros(nRepeat), torch.ones(nRepeat), torch.zeros(nRepeat), torch.zeros(nRepeat), torch.zeros(nRepeat), torch.ones(nRepeat)}, 1)
label2 = torch.cat({torch.zeros(nRepeat), torch.zeros(nRepeat), torch.zeros(nRepeat), torch.zeros(nRepeat), torch.ones(nRepeat), torch.zeros(nRepeat), torch.zeros(nRepeat)}, 1)
