...
function Provider:__init(full)
  ...
  -- load dataset
  self.trainData = {
     data = torch.Tensor(15000, 3072),
     labels = torch.Tensor(15000),
     size = function() return trsize end
  }
  local subset = matio.load('torch_train.mat')
  local subset2 = matio.load('torch_test.mat')
  nRepeat = 4
  ...
  trainData.data = subset.torch_train:double()
  --print(#trainData.data)
  trainData.labels = train_Y

  self.testData = {
     data = subset2.torch_test:double(),
