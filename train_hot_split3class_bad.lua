...
opt = lapp[[
   -s,--save                  (default "logs_hot_split_3_class_bad")      subdirectory to save logs
   -b,--batchSize             (default 128)          batch size
   -r,--learningRate          (default 2)        learning rate
   --learningRateDecay        (default 1.0e-7)      learning rate decay
   --weightDecay              (default 0.0005)      weightDecay
   -m,--momentum              (default 0.5)         momentum
   --epoch_step               (default 25)          epoch step
   --model                    (default vgg_split3class_bad)     model name
...
--label 3 class: xA,AB(A),AC(A),BC(A),xB,AB(B),AC(B),BC(B),xC,AB(C),AC(C),BC(C),AB(AB),AC(AC),BC(BC)
label0 = torch.cat({torch.ones(nRepeat), torch.zeros(nRepeat), torch.zeros(nRepeat), torch.zeros(nRepeat), torch.zeros(nRepeat), torch.zeros(nRepeat), torch.zeros(nRepeat), torch.zeros(nRepeat), torch.zeros(nRepeat), torch.ones(nRepeat), torch.zeros(nRepeat), torch.zeros(nRepeat), torch.ones(nRepeat), torch.zeros(nRepeat), torch.zeros(nRepeat)}, 1)
label1 = torch.cat({torch.zeros(nRepeat), torch.zeros(nRepeat), torch.zeros(nRepeat), torch.ones(nRepeat), torch.zeros(nRepeat), torch.zeros(nRepeat), torch.zeros(nRepeat), torch.zeros(nRepeat), torch.zeros(nRepeat), torch.ones(nRepeat), torch.zeros(nRepeat), torch.zeros(nRepeat), torch.zeros(nRepeat), torch.zeros(nRepeat), torch.zeros(nRepeat)}, 1)
label2 = torch.cat({torch.zeros(nRepeat), torch.zeros(nRepeat), torch.zeros(nRepeat), torch.zeros(nRepeat), torch.zeros(nRepeat), torch.zeros(nRepeat), torch.ones(nRepeat), torch.zeros(nRepeat), torch.zeros(nRepeat), torch.zeros(nRepeat), torch.zeros(nRepeat), torch.zeros(nRepeat), torch.ones(nRepeat), torch.zeros(nRepeat), torch.zeros(nRepeat)}, 1)
